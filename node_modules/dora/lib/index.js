...
function createServer(_args, callback) {
  ...
  var context = { port: port, cwd: cwd, localIP: require('internal-ip')() };
  ...
  pluginNames = pluginNames.concat([(0, _path.join)(__dirname, './plugins/static'), (0, _path.join)(__dirname, './plugins/serve-index')]);
