...
var _doraUtilIsAsync = require('dora-util-is-async');

var _doraUtilIsAsync2 = _interopRequireDefault(_doraUtilIsAsync);
...
function isAsync(func) {
  return (0, _doraUtilIsAsync2.default)(func.toString().match(/function[^{]+\{([\s\S]*)\}$/)[1]);
}
...
function applyPlugins(plugins, name, context, pluginArgs) {
  ...
  (0, _reduceAsync2.default)(plugins, pluginArgs, function (memo, plugin, callback) {
    ...
    if (name === 'middleware') {
      ...
      _co2.default.wrap(func).call(context).then(function (val) {
        callback(null, val);
      }, callback);
