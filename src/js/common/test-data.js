const tableList = [
    {
        ...
        images: [{
            height: "533",
            img: "https://gdp.alicdn.com/imgextra/i2/52995017/TB2oSc5npXXXXaNXXXXXXXXXXXX-52995017.jpg",
            imgsize: "400,533",
            width: "400"
        }, {
            height: "300",
        ...
        img: "http://https://gdp.alicdn.com/imgextra/i2/52995017/TB2oSc5npXXXXaNXXXXXXXXXXXX-52995017.jpg",
        imgsize: "400,533",
        keyword: "",
...
const dataShowRelySale = [];
for (let i = 1; i < 80; i++) {
  dataShowRelySale.push({
    id: i,
    customer: `李小二${i}`,
    number: `32${i}`,
    contact: `哈哈${i}`,
...
export default {
    ...
    dataShow: dataShow,
    dataShowRelySale: dataShowRelySale,
};
